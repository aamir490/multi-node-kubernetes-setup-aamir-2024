...
################### PASTE IT ONLY [[ MASTER ]]  ( Not This , paste it your Command ) :--->
...
################### PASTE IT ONLY [[ WORKER ]] ( Not This , paste it your Command ) :--->
...
###### If u missed copying the join command, execute the command in the master node to recreate the token with the join command :--->
...
###### NOTE:- For Labeled the worker node :--->
...
###### Main Kubernetes Configuration Directory :--->
$ cd /etc/kubernetes/
...
# - copy all data 'admin.conf'
# - make Direcory in Hostmachine , and create file 'k8s-cleint-vd.txt'
# - Open 'k8s-cleint-vd.txt' & Change IP adress
